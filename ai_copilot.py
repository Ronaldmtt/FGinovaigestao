...
MUITO CRÍTICO: NUNCA presuma que um projeto não tem tarefas ativas apenas porque o status dele no summary está como "concluido". Se o array `tarefas_resumo` tiver itens `em_andamento` ou `pendente`, confie no array.
