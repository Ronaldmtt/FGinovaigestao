...
try:
    ...
    if start_index == -1:
        print("Error: Could not find @app.route('/reports/generate_pdf') in file.")
        exit(1)
    ...
    print(f"Successfully updated routes.py. Replaced content starting at line {start_index+1}.")
